...
The Vnxcoin Core daemon can be configured to act as a trusted "border
router", implementing the vnxcoin wire protocol and relay, making
...
The ZeroMQ feature in Vnxcoin Core requires ZeroMQ API version 4.x or
...
These options can also be provided in vnxcoin.conf.
