...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s vnxcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  vnxcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded vnxcoin transaction") + "\n" +
              "  vnxcoin-tx [options] -create [commands]   " + _("Create hex-encoded vnxcoin transaction") + "\n" +
              "\n";
