...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/vnxcoin-project/vnxcoin>";
    const std::string URL_WEBSITE = "<https://vnxcoin.org>";
